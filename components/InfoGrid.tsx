...
const SECTIONS = [
  ...
  },
  {
    ...
    plans: [
      { name: 'GENIUSINVESTAI', min: 'Min. $499', rate: '1.5%', period: '243 Days' },
      { name: 'ALPHAINVESTAI', min: 'Min. $100,000', rate: '3%', period: '300 Days' },
      { name: 'CHAINMASTER(AFFILIATE)', min: 'Min. $4,999', rate: '2%', period: '548 Days' },
      { name: 'ELITEAI', min: 'Min. $500,000', rate: '7% Daily', period: '260 Days' },
    ],
