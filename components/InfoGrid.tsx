...
const SECTIONS = [
  ...
  },
  {
    ...
    plans: [
      { name: 'GENIUSINVESTAI', min: 'Min. $499', rate: '5% Daily', period: '30 Days' },
      { name: 'ALPHAINVESTAI', min: 'Min. $100,000', rate: '7% Daily', period: '60 Days' },
      { name: 'CHAINMASTER(AFFILIATE)', min: 'Min. $4,999', rate: '10% Daily', period: '90 Days' },
      { name: 'ELITEAI', min: 'Min. $500,000', rate: '12% Daily', period: '120 Days' },
    ],
