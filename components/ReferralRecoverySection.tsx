...
export default function ReferralRecoverySection() {
  return (
    <div className="max-w-6xl mx-auto mb-12 sm:mb-16">
      ...
      <div className="bg-gray-900/60 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-amber-500/20 shadow-2xl shadow-amber-500/10 mb-8 sm:mb-12">
        <div className="text-center mb-6 sm:mb-8">
          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-amber-400 to-yellow-600 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-amber-500/50">
          ...
          <p className="text-amber-300 text-lg sm:text-xl font-semibold">Earn More by Sharing the Opportunity</p>
        </div>
        ...
        <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start space-x-3 sm:space-x-4 p-4 bg-gray-800/50 rounded-xl border border-amber-500/30">
                <div className="w-8 h-8 bg-gradient-to-br from-amber-400 to-yellow-600 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                  <span className="text-black font-bold text-sm">1</span>
                </div>
                <div>
                  <p className="text-amber-300 font-semibold text-sm sm:text-base">💼 Level 1 Referral</p>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4 p-4 bg-gray-800/50 rounded-xl border border-amber-500/30">
                ...
                <div>
                  <p className="text-amber-300 font-semibold text-sm sm:text-base">🤝 Level 2 Referral</p>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4 p-4 bg-gray-800/50 rounded-xl border border-amber-500/30">
                ...
                <div>
                  <p className="text-amber-300 font-semibold text-sm sm:text-base">🌐 Level 3 Referral</p>
      ...
      <div className="bg-gray-900/60 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-amber-500/20 shadow-2xl shadow-amber-500/10">
        ...
        <div className="relative aspect-video rounded-xl overflow-hidden bg-black border border-amber-500/20 mb-4">
          <iframe
        ...
        <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
          ...
          <div className="mb-6 sm:mb-8">
            <div className="flex items-center space-x-3 mb-4 sm:mb-6">
              <CheckCircle className="w-6 h-6 sm:w-8 sm:h-8 text-amber-400" />
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="p-4 sm:p-6 bg-gray-800/50 rounded-xl border border-amber-500/30">
                <h5 className="text-lg sm:text-xl font-semibold text-amber-300 mb-2">1. Enrollment & Verification</h5>
              ...
              <div className="p-4 sm:p-6 bg-gray-800/50 rounded-xl border border-amber-500/30">
                <h5 className="text-lg sm:text-xl font-semibold text-amber-300 mb-2">2. Investment Matching via ChainMasterBot</h5>
                <p className="text-gray-300 text-sm sm:text-base">
              ...
              <div className="p-4 sm:p-6 bg-gray-800/50 rounded-xl border border-amber-500/30">
                <h5 className="text-lg sm:text-xl font-semibold text-amber-300 mb-2">3. Monthly Recovery Payments (10%)</h5>
                <p className="text-gray-300 text-sm sm:text-base">
              ...
              <div className="p-4 sm:p-6 bg-gray-800/50 rounded-xl border border-amber-500/30">
                <h5 className="text-lg sm:text-xl font-semibold text-amber-300 mb-2">4. Transparent Tracking</h5>
                <p className="text-gray-300 text-sm sm:text-base">
              ...
              <div className="p-4 sm:p-6 bg-gray-800/50 rounded-xl border border-amber-500/30">
                <h5 className="text-lg sm:text-xl font-semibold text-amber-300 mb-2">5. Full Recovery Guarantee</h5>
                <p className="text-gray-300 text-sm sm:text-base">
          ...
          <div className="border-t border-gray-700 pt-6 sm:pt-8 mb-6 sm:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              <div className="text-center p-4 bg-gray-800/50 rounded-xl border border-amber-500/30">
                <Lock className="w-6 h-6 sm:w-8 sm:h-8 text-amber-400 mx-auto mb-2" />
                <h5 className="text-base sm:text-lg font-semibold text-amber-300 mb-2">Secure & Automated</h5>
              ...
              <div className="text-center p-4 bg-gray-800/50 rounded-xl border border-amber-500/30">
                ...
                <h5 className="text-base sm:text-lg font-semibold text-amber-300 mb-2">Performance-Driven</h5>
                <p className="text-gray-400 text-sm">Uses smart logic to accelerate recovery timelines</p>
              </div>
              
              <div className="text-center p-4 bg-gray-800/50 rounded-xl border border-amber-500/30">
                <Eye className="w-6 h-6 sm:w-8 sm:h-8 text-amber-400 mx-auto mb-2" />
                <h5 className="text-base sm:text-lg font-semibold text-amber-300 mb-2">Client Dashboard</h5>
